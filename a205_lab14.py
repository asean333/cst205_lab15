...
# I had to mess up my file naming scheme for this......... </3
...
# I'm so sorry (bee movie script)
bee_script = ''' According to all known laws of aviation, there is no way a bee should be able to fly.
...
stop_words = [
    ...
    'with', 'you', 'your', 'i', 'me', 'my', 'we', 'our', 'us', 'he', 'she',
    'him', 'her', 'his', 'hers', 'them', 'what', 'which', 'who', 'whom',
    'been', 'being', 'do', 'does', 'did', 'doing', 'would', 'could', 'should',
    'can', 'just', 'now', 'so', 'too', 'very', 'from', 'up', 'down', 'out',
    'over', 'again', 'once'
]
additional_stop_words = ['uh', 'oh', 'yeah', 'okay', 'hmm', 'um', 'ha', 'hey']
...
for char in unwanted_chars:
    bee_script = bee_script.replace(char, "")

# split and normalize text
words = bee_script.lower().split()

# filter out stop words and unwanted characters
